module github.com/n8maninger/renterd-mock

go 1.20

require (
	go.sia.tech/jape v0.9.1-0.20230525021720-ecf031ecbffb
	go.sia.tech/renterd v0.3.0-beta.0.20230612195348-e1f1e8a9daf1
...
require (
	...
	go.sia.tech/core v0.1.12-0.20230525021639-f38630eccb9c // indirect
